...
class Konfigurasi_model extends CI_Model
{
    ...
    function get_data($table,$id)
    {
        ...
        if($table=='branchs'){
            ...
            $this->db->select($table.".*, users.user_id, users.user_username, branchs.branch_id, branchs.branch_name, branchs.branch_flag");
            $this->db->join("users",$table_column."=users.user_id","left");
            $this->db->join("branchs",'location_branch_id=branch_id','left');
        }else{
