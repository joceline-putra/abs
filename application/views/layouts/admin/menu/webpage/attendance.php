        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab1">
                <!-- <div class="col-md-12 col-xs-12 col-sm-12"> -->
                    ...
                    <div class="row" style="margin-bottom:20px;">   
                        <div class="col-md-12 col-xs-12">
                            <div id="map" style="height: 250px; width: 100%;border:1px solid #eaeaea;"></div>
                        </div>
                    </div>                 
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo $google_map_api_key;?>&libraries=places" type="text/javascript"></script>
